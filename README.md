...
[实验报告与原理详解](docs/experiment.md) · [实现与复现说明](docs/queue_eviction.md) · [上游 PR #278](https://github.com/GeeeekExplorer/nano-vllm/pull/278)
...
原始数据见 [docs/raw](docs/raw)，报告中的图片为 VS Code 展示已保存日志的截图。上传整理没有重新测量 GPU 性能。
